                ...
                <?php foreach ($foods as $food) : ?>
                    <div class="col text-center">
                        <div class="card mt-5">
                            ...
                            <div class="card-body">
                                <p class="card-text"><?= $food->getName() ?></p>
                                <p class="card-text"><?= $food->getDescription() ?></p>
                                <p class="card-text"><?= $food->getPrice() ?></p>
                                <p class="card-text"><?= $food->listIngredients() ?></p>
                                <p class="card-text"><?= $food->getExpiration() ?></p>
                            </div>
                        </div>
                ...
                <?php foreach ($toys as $toy) : ?>
                    <div class="col text-center">
                        <div class="card mt-5">
                            ...
                            <div class="card-body">
                                <p class="card-text"><?= $toy->getName() ?></p>
                                <p class="card-text"><?= $toy->getDescription() ?></p>
                                <p class="card-text"><?= $toy->getPrice() ?></p>
                                <p class="card-text"><?= $toy->getColor() ?></p>
                                <p class="card-text"><?= $toy->listMaterials() ?></p>
                            </div>
                        </div>
                ...
                <?php foreach ($kennels as $kennel) : ?>
                    <div class="col text-center">
                        <div class="card my-5">
                            ...
                            <div class="card-body">
                                <p class="card-text"><?= $kennel->getName() ?></p>
                                <p class="card-text"><?= $kennel->getDescription() ?></p>
                                <p class="card-text"><?= $kennel->getPrice() ?></p>
                                <p class="card-text"><?= $kennel->getColor() ?></p>
                                <p class="card-text"><?= $kennel->getSize() ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
